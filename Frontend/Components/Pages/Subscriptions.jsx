  ...
  return (
    <div className="space-y-8 transition-colors duration-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl">
        ...
        <div className="bg-gradient-to-b from-slate-900 to-slate-950 dark:from-slate-900 dark:to-indigo-950/40 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between relative shadow-2xl transition-colors duration-200">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-bold text-amber-400 text-sm uppercase tracking-wider">Premium Plus</h3>
              <p className="text-2xl font-black text-white mt-1">₹199 <span className="text-xs text-slate-400 font-medium">/ month</span></p>
            </div>
            <p className="text-xs text-slate-400">Zero-effort automated accounting ecosystem utilizing background agent parsers.</p>
            <div className="h-px bg-slate-800 my-4" />
            
            <ul className="space-y-3">
              <PlanFeature inclusion="Everything included in Premium" active={true} darkTheme={true} />
              <PlanFeature inclusion="Smart OCR Receipt Camera Scanning" active={true} darkTheme={true} />
              <PlanFeature inclusion="AI Automated Gmail Transaction Scraping" active={true} darkTheme={true} />
              <PlanFeature inclusion="Cross-Platform Global Bank Sync Engine" active={true} darkTheme={true} />
              <PlanFeature inclusion="Predictive Cash Flow Intelligence Forecasting" active={true} darkTheme={true} />
            </ul>
          </div>
